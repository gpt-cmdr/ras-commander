...
This file provides canonical local guidance for agents and developers working
with the `ras_commander.dss` subpackage.
...
├── CLAUDE.md            # This file
├── AGENTS.md            # Thin compatibility wrapper
