...
This class is intentionally separate from the native-unsteady ``RasDocker``
API on PR #342. A later integration may delegate to this adapter without
changing either public method contract.
"""
