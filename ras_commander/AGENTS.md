...
- Network conflation: `RasNetworkConflation` is the canonical generic network-to-RAS API; retain `RasHydrofabric` as the compatibility-oriented public name and keep NWM/NextGen behavior in adapters rather than the core workflow.
