...
- Hydrofabric conflation: `RasHydrofabric` (generic NHDPlus, NWM, and NextGen adapters; explicit matched/ambiguous/unmatched outputs; multi-criteria candidate scoring and along-flowpath measures)
