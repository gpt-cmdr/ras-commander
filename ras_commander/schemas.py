...
DATAFRAME_SCHEMAS = {
    "terrain_agreement_xs_metrics": {
        "description": "One row per cross section comparing authored geometry with sampled terrain.",
        "accessor": "RasTerrainAgreement.analyze(...).xs_metrics_df",
        "source": "RasTerrainAgreement._compare_collections()",
        "extra_columns": False,
        "dynamic": False,
        "columns": [
            {"name": "xs_id", "dtype": "str", "description": "Stable cross-section identifier."},
            {"name": "river", "dtype": "str", "description": "River name."},
            {"name": "reach", "dtype": "str", "description": "Reach name."},
            {"name": "rs", "dtype": "str", "description": "River station."},
            {"name": "n_source_points", "dtype": "int", "description": "Finite authored profile point count."},
            {"name": "n_terrain_points", "dtype": "int", "description": "Finite sampled terrain point count."},
            {"name": "n_comparison_points", "dtype": "int", "description": "Common-grid comparison point count."},
            {"name": "source_station_min", "dtype": "float", "description": "Minimum authored station."},
            {"name": "source_station_max", "dtype": "float", "description": "Maximum authored station."},
            {"name": "terrain_station_min", "dtype": "float", "description": "Minimum terrain station."},
            {"name": "terrain_station_max", "dtype": "float", "description": "Maximum terrain station."},
            {"name": "station_overlap", "dtype": "float", "description": "Shared station span."},
            {"name": "station_coverage_ratio", "dtype": "float", "description": "Shared span divided by authored span."},
            {"name": "source_vertical_range", "dtype": "float", "description": "Authored elevation range on the comparison span."},
            {"name": "source_thalweg_elevation", "dtype": "float", "description": "Minimum authored elevation."},
            {"name": "terrain_thalweg_elevation", "dtype": "float", "description": "Minimum terrain elevation."},
            {"name": "thalweg_elevation_difference", "dtype": "float", "description": "Authored minus terrain thalweg elevation."},
            {"name": "source_thalweg_station", "dtype": "float", "description": "Authored thalweg station."},
            {"name": "terrain_thalweg_station", "dtype": "float", "description": "Terrain thalweg station."},
            {"name": "thalweg_station_difference", "dtype": "float", "description": "Authored minus terrain thalweg station."},
            {"name": "residual_mean", "dtype": "float", "description": "Mean authored-minus-terrain elevation residual."},
            {"name": "residual_std", "dtype": "float", "description": "Population standard deviation of elevation residuals."},
            {"name": "residual_min", "dtype": "float", "description": "Minimum elevation residual."},
            {"name": "residual_max", "dtype": "float", "description": "Maximum elevation residual."},
            {"name": "residual_p25", "dtype": "float", "description": "25th percentile elevation residual."},
            {"name": "residual_p50", "dtype": "float", "description": "Median elevation residual."},
            {"name": "residual_p75", "dtype": "float", "description": "75th percentile elevation residual."},
            {"name": "rmse", "dtype": "float", "description": "Elevation residual root mean square error."},
            {"name": "nrmse", "dtype": "float", "description": "RMSE normalized by authored elevation range."},
            {"name": "pearson_correlation", "dtype": "float", "description": "Zero-shift Pearson correlation."},
            {"name": "max_shifted_correlation", "dtype": "float", "description": "Best bounded shifted Pearson correlation."},
            {"name": "shift_distance", "dtype": "float", "description": "Signed terrain-profile station shift at best correlation."},
            {"name": "stage_count", "dtype": "int", "description": "Evaluated stage count."},
            {"name": "avg_inundation_overlap", "dtype": "float", "description": "Mean wet-width intersection-over-union."},
            {"name": "avg_top_width_agreement", "dtype": "float", "description": "Mean symmetric top-width agreement."},
            {"name": "avg_flow_area_agreement", "dtype": "float", "description": "Mean symmetric flow-area agreement."},
            {"name": "avg_flow_area_overlap", "dtype": "float", "description": "Mean flow-area intersection-over-union."},
            {"name": "avg_hydraulic_radius_agreement", "dtype": "float", "description": "Mean symmetric hydraulic-radius agreement."},
            {"name": "valid", "dtype": "bool", "description": "Whether this cross section produced valid profile metrics."},
            {"name": "reason_codes", "dtype": "str", "description": "Semicolon-delimited data-quality reason codes."},
            {"name": "flagged", "dtype": "bool", "description": "Whether data quality or a screening threshold flagged the section."},
            {"name": "flag_reasons", "dtype": "str", "description": "Semicolon-delimited screening flag codes."},
        ],
    },
    "terrain_agreement_stage_metrics": {
        "description": "One row per cross section and stage with exact piecewise-linear hydraulic agreement metrics.",
        "accessor": "RasTerrainAgreement.analyze(...).stage_metrics_df",
        "source": "RasTerrainAgreement._stage_metrics()",
        "extra_columns": False,
        "dynamic": False,
        "columns": [
            {"name": "xs_id", "dtype": "str", "description": "Stable cross-section identifier."},
            ...
            {"name": "reach", "dtype": "str", "description": "Reach name."},
            {"name": "rs", "dtype": "str", "description": "River station."},
            {"name": "stage", "dtype": "float", "description": "Water-surface elevation used for comparison."},
            {"name": "source_top_width", "dtype": "float", "description": "Authored-profile wetted top width."},
            {"name": "terrain_top_width", "dtype": "float", "description": "Terrain-profile wetted top width."},
            {"name": "top_width_agreement", "dtype": "float", "description": "Symmetric top-width agreement."},
            {"name": "inundation_overlap", "dtype": "float", "description": "Wet-width intersection-over-union."},
            {"name": "source_flow_area", "dtype": "float", "description": "Authored-profile flow area."},
            {"name": "terrain_flow_area", "dtype": "float", "description": "Terrain-profile flow area."},
            {"name": "flow_area_agreement", "dtype": "float", "description": "Symmetric flow-area agreement."},
            {"name": "flow_area_overlap", "dtype": "float", "description": "Flow-area intersection-over-union."},
            {"name": "source_wetted_perimeter", "dtype": "float", "description": "Authored-profile wetted perimeter."},
            {"name": "terrain_wetted_perimeter", "dtype": "float", "description": "Terrain-profile wetted perimeter."},
            {"name": "source_hydraulic_radius", "dtype": "float", "description": "Authored-profile hydraulic radius."},
            {"name": "terrain_hydraulic_radius", "dtype": "float", "description": "Terrain-profile hydraulic radius."},
            {"name": "hydraulic_radius_agreement", "dtype": "float", "description": "Symmetric hydraulic-radius agreement."},
            {"name": "residual_mean", "dtype": "float", "description": "Mean wet-domain elevation residual."},
            {"name": "residual_std", "dtype": "float", "description": "Wet-domain residual standard deviation."},
            {"name": "residual_min", "dtype": "float", "description": "Minimum wet-domain residual."},
            {"name": "residual_max", "dtype": "float", "description": "Maximum wet-domain residual."},
            {"name": "residual_p25", "dtype": "float", "description": "25th percentile wet-domain residual."},
            {"name": "residual_p50", "dtype": "float", "description": "Median wet-domain residual."},
            {"name": "residual_p75", "dtype": "float", "description": "75th percentile wet-domain residual."},
            {"name": "rmse", "dtype": "float", "description": "Wet-domain elevation residual RMSE."},
            {"name": "nrmse", "dtype": "float", "description": "Wet-domain RMSE normalized by authored elevation range."},
            {"name": "valid", "dtype": "bool", "description": "Whether inundation exists and overlap is computable."},
            {"name": "reason_codes", "dtype": "str", "description": "Semicolon-delimited stage reason codes."},
        ],
    },
