...
The published native images install source `604704d440c49a39d6f6e8bae262e2233d895dd0`; Wine controller source is `dc60b219091e85bcb4564eca45313475c39ce58a`, with Windows library source `9e4217713e954236b0c16023e1815c6f2b7a5309`. Those revisions identify the published image payloads. The host API follows the installed ras-commander release. Use the public image references below with `pull="always"`.
...
Build all three native images from one reviewed ras-commander revision. It must contain the Dockerfile, lock file, bundler, extractor, and installed library worker. Record that exact revision as `RAS_COMMANDER_COMMIT`.
...
HEC-RAS 7.0.1, June 2026. Use [extract_installer.py][extractor-701] to recover the native
...
[dockerfile]: https://github.com/gpt-cmdr/ras-commander/blob/main/containers/hecras-unsteady/Dockerfile
[lock]: https://github.com/gpt-cmdr/ras-commander/blob/main/containers/hecras-unsteady/requirements.lock
[bundler]: https://github.com/gpt-cmdr/ras-commander/blob/main/containers/hecras-unsteady/bundle_runtime.py
[license]: https://github.com/gpt-cmdr/ras-commander/blob/main/LICENSE
[setup]: https://github.com/gpt-cmdr/ras-commander/blob/main/setup.py
[pyproject]: https://github.com/gpt-cmdr/ras-commander/blob/main/pyproject.toml
[package]: https://github.com/gpt-cmdr/ras-commander/tree/main/ras_commander
[worker]: https://github.com/gpt-cmdr/ras-commander/blob/main/ras_commander/_container_compute.py
[cmdr]: https://github.com/gpt-cmdr/ras-commander/blob/main/ras_commander/RasCmdr.py
[project-api]: https://github.com/gpt-cmdr/ras-commander/blob/main/ras_commander/RasPrj.py
[docker-api]: https://github.com/gpt-cmdr/ras-commander/blob/main/ras_commander/RasDocker.py
[notebook]: https://github.com/gpt-cmdr/ras-commander/blob/main/examples/512_docker_precompute_and_linux_compute.ipynb
[guide]: https://github.com/gpt-cmdr/ras-commander/blob/main/docs/user-guide/container-execution.md
[extractor-701]: https://github.com/gpt-cmdr/ras-commander/blob/main/containers/hecras-unsteady/extract_installer.py
[installed-docker-api]: https://github.com/gpt-cmdr/ras-commander/blob/main/ras_commander/RasDocker.py
[plan-api]: https://github.com/gpt-cmdr/ras-commander/blob/main/ras_commander/RasPlan.py
