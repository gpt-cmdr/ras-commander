window.RAS_EXAMPLE_PROJECT_PROFILES = {
  projects: {
    ...
    "middle-chattahoochee-lake-harding-al03130002": {
      modelType: "197-model 1D steady BLE corpus",
    ...
    "upper-guadalupe-ras-model-upgu1-upgu1-prj-030c0a6a": {
      modelType: "2D unsteady",
      version: "HEC-RAS 6.3.1 source; unsteady-start validated",
      summary: "Uppermost domain in the four-model Upper Guadalupe cascade. Its two-core p01 plan reached owned unsteady-solver startup after the portable HDF association repairs.",
      groupId: "upper-guadalupe",
      variantLabel: "UPGU1",
    },
    "upper-guadalupe-ras-model-upgu2-upgu2-prj-917be43b": {
      modelType: "2D unsteady",
      version: "HEC-RAS 6.3.1 source; not solver-start qualified",
      summary: "Second domain in the four-model Upper Guadalupe cascade. The delivery includes a modified-terrain triplet and supplied result HDFs; solver-start qualification is not established.",
      groupId: "upper-guadalupe",
      variantLabel: "UPGU2",
    },
    "upper-guadalupe-ras-model-upgu3-upgu3-prj-c79886b4": {
      modelType: "2D unsteady",
      version: "HEC-RAS 6.3.1 source; not solver-start qualified",
      summary: "Third domain in the four-model Upper Guadalupe cascade. The delivery includes a modified-terrain triplet and supplied result HDFs; solver-start qualification was not attempted.",
      groupId: "upper-guadalupe",
      variantLabel: "UPGU3",
    },
    "upper-guadalupe-ras-model-upgu4-upgu4-prj-a9a9000f": {
      modelType: "2D unsteady",
      version: "HEC-RAS 6.3.1 source; not solver-start qualified",
      summary: "Downstream domain in the four-model Upper Guadalupe cascade. The delivery includes channel and polygon terrain modifications plus supplied result HDFs; solver-start qualification was not attempted.",
      groupId: "upper-guadalupe",
      variantLabel: "UPGU4",
    },
    "pedernales-12090206": {
