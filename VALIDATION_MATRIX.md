...
Last updated: 2026-04-27 06:31:00 -04:00
...
| Tickfaw | 08070203 | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | Organized at `Organized\Tickfaw_08070203`; E2E audit `e2e_delivery_audit_20260424_190917.json` found 1 project, 0 issues, and 7 local hydraulic plan HDFs. Preprocessor report `geometry_preprocessor_validation_20260424_185812.json` passed plan 13 / geometry 05 in 662.9 seconds with 0 errors and 0 warnings. Notebook `examples/955_ebfe_tickfaw_validation.ipynb` verifies the organized project, local assets, preprocessor evidence, and 7/7 local result HDF paths. HUC is listed as `Tickpaw` in EPA NHDPlus/WBD references. |
