...
def test_gridded_precipitation_configuration_info_is_concise(tmp_path, caplog):
    ...
    # Must be readable: set_gridded_precipitation builds the payload before editing
    # the .u##, so an empty placeholder now raises (see
    # test_set_gridded_precipitation_rejects_unreadable_netcdf in test_ras_precip_hdf.py).
